...
U.S. hegemony means international trade relies on English, and programmers of all ilk end up learning at least a little bit of English, if only so they can access the latest documentation on the latest features on the cutting edge
